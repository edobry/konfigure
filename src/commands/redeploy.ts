...
export default class RedeployCommand extends BaseCommand<
    typeof RedeployCommand.flags,
    typeof RedeployCommand.args
> {
    static description =
    ...
    async command(
        ...
        await processDeployments(ctx, async (chart) => {
